...
<div class="btn-group">	
	{{  Form::select('name',$status,null,['class' => 'required form-control select2','id'=>'provider_id']) }}
	<div class="form-group {{ $errors->has('operation_id') ? 'has-error' : ''}} d-none">
	    ...
	    <input class="form-control" name="operation_id" type="number" id="operation_id" value="{{ isset($item->id) ? $item->id : ''}}" >
