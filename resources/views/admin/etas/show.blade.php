...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Eta {{ $eta->id }}</div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th>ID</th><td>{{ $eta->id }}</td>
                                    </tr>
                                    <tr><th> Eta </th><td> {{ $eta->eta }} </td></tr><tr><th> Operation Id </th><td> {{ $eta->operation_id }} </td></tr><tr><th> User Id </th><td> {{ $eta->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
