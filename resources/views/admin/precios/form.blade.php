<div class="form-group {{ $errors->has('precio') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="precio" type="number" id="precio" value="{{ isset($precio->precio) ? $precio->precio : ''}}" >
    {!! $errors->first('precio', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('cantidad') ? 'has-error' : ''}}">
    <label for="cantidad" class="control-label">{{ 'Cantidad' }}</label>
    <input class="form-control" name="cantidad" type="number" id="cantidad" value="{{ isset($precio->cantidad) ? $precio->cantidad : ''}}" >
...
<div class="form-group {{ $errors->has('etd') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="etd" type="date" id="etd" value="{{ isset($precio->etd) ? $precio->etd : ''}}" >
...
<div class="form-group {{ $errors->has('producto_id') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="producto_id" type="number" id="producto_id" value="{{$product->id}}" >
