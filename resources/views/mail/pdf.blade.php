    ...
    <tr>
        <td align="center" valign="top" width="600" style="width:600px;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" class="templateContainer" style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;border: 0;max-width: 600px !important;">
                    ...
                    <tbody class="mcnTextBlockOuter">
                      <tr>
                        <td valign="top" class="mcnTextBlockInner" style="padding-top: 9px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;">
                                ...
                                <td valign="top" class="mcnTextContent" style="padding-top: 0;padding-right: 18px;padding-bottom: 9px;padding-left: 18px;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;word-break: break-word;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                                  <p style="margin: 10px 0;padding: 0;mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;color: #202020;font-family: Helvetica;font-size: 16px;line-height: 150%;text-align: left;">
                                    <font style="vertical-align: inherit;">
                                      <font style="vertical-align: inherit;">La siguiente operación acaba de ser creada:</font>
                                    </font>
                                  </p>
                                  </p>
                                </td>
                          ...
                          <table class="table">
                                <tbody>
                                    <tr><th>Número Operación</th><td>{{ $numeroOperacion }}</td></tr>
                                    <tr><th>Número de Factura</th><td> {{ $numeroFactura }} </td></tr>
                                    <tr><th>Proveedor</th><td> {{ $proveedor }} </td></tr>
                                    <tr><th>Productos:Cantidades</th><td> {{ $productosCantidades }} </td></tr>
                                    <tr><th>Costo</th><td> {{ $precio }} </td></tr>
                                    <tr><th>ETD</th><td> {{ $etd }} </td></tr>
                                </tbody>
                          </table>
                          <!--[if mso]>
                                                    </td>
              ...
              <tr>
                <td valign="top" id="templateFooter" style="mso-line-height-rule: exactly;-ms-text-size-adjust: 100%;-webkit-text-size-adjust: 100%;background-color: #fafafa;background-image: none;background-repeat: no-repeat;background-position: center;background-size: cover;border-top: 0;border-bottom: 0;padding-top: 8px;padding-bottom: 8px;"></td>
              </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
            </td>
